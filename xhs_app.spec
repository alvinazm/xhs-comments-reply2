...
a = Analysis(
    ...
    collect_all_from=["logging.handlers", "importlib", "importlib.resources", "importlib.metadata"],
    # 排除无效的依赖，否则会导致应用包非常大，不要删除
    excludes=[
        "numpy", "pandas", "matplotlib", "scipy", "sklearn", "seaborn",
        "IPython", "jupyter", "notebook", "lab", "qtconsole",
        "PyQt5", "PyQt6", "tkinter", "PIL", "cv2",
        "scipy", "statsmodels", "bokeh", "plotly", "altair",
        "xarray", "dask", "distributed", "intake", "zarr",
        "sphinx", "nbsphinx", "nbconvert", "pypandoc",
        "tensorflow", "torch", "keras", "transformers",
        "sqlalchemy", "psycopg2", "asyncpg", "pymysql",
        "cryptography", "paramiko", "fabric",
        "cv2", "opencv", "av", "imageio", "moviepy",
        "pygame", "pyglet",
    ],
